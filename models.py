...
class AppSettings:
    ...
    api_tpm: int = 100_000
    api_top_p: float = 1.0
    api_temperature: float = 1.3
    api_presence_penalty: float = 0.0
    api_frequency_penalty: float = 0.0
    api_think_switch: bool = True
    api_think_depth: str = "low"
    ...
    translation_pre_line_counts: int = 3
    translation_rounds: int = 6
    translation_enable_smart_round_limit: bool = False
    translation_smart_round_limit_multiplier: int = 2
    translation_enable_retry_backoff: bool = True
